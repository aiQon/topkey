/**
 * $Id: mxConstants.java,v 1.74 2011-12-16 00:13:18 david Exp $
...
public class mxConstants
{
	...
	static
	{
		try
		{
			mxConstants.SHADOW_COLOR = Color.gray;
			mxConstants.DEFAULT_VALID_COLOR = Color.GREEN;
			mxConstants.DEFAULT_INVALID_COLOR = Color.RED;
			mxConstants.RUBBERBAND_BORDERCOLOR = new Color(51, 153, 255);
			mxConstants.RUBBERBAND_FILLCOLOR = new Color(51, 153, 255, 80);
			mxConstants.HANDLE_BORDERCOLOR = Color.black;
			mxConstants.HANDLE_FILLCOLOR = Color.green;
			mxConstants.LABEL_HANDLE_FILLCOLOR = Color.yellow;
			mxConstants.LOCKED_HANDLE_FILLCOLOR = Color.red;
			mxConstants.CONNECT_HANDLE_FILLCOLOR = Color.blue;
			mxConstants.EDGE_SELECTION_COLOR = Color.green;
			mxConstants.VERTEX_SELECTION_COLOR = Color.green;
		}
		catch (Exception e)
		{
			// Occurs when running on GAE, Color is a
			// blacklisted class
			mxConstants.SHADOW_COLOR = null;
			mxConstants.DEFAULT_VALID_COLOR = null;
			mxConstants.DEFAULT_INVALID_COLOR = null;
			mxConstants.RUBBERBAND_BORDERCOLOR = null;
			mxConstants.RUBBERBAND_FILLCOLOR = null;
			mxConstants.HANDLE_BORDERCOLOR = null;
			mxConstants.HANDLE_FILLCOLOR = null;
			mxConstants.LABEL_HANDLE_FILLCOLOR = null;
			mxConstants.LOCKED_HANDLE_FILLCOLOR = null;
			mxConstants.CONNECT_HANDLE_FILLCOLOR = null;
